...
import { COMPTROLLER_ABI, VAULT_PROXY_ABI } from '../constants/contracts';
...
const FundRedeemPage: React.FC = () => {
    ...
    const handleRedeem = async () => {
        ...
        try {
            ...
            const vaultProxy = new ethers.Contract(vaultProxyAddress, VAULT_PROXY_ABI, signer);

            const tx = await vaultProxy.redeemSharesInKind(recipient, sharesToRedeem, [], []);
            setTxHash(tx.hash);
            await tx.wait();
